        ...
        <div class="signin-signup">
            <form action="/sign-in" method="post" id="check-admin" class="sign-in-form">
                ...
                <div class="input-field">
                    ...
                    <input type="text" placeholder="Username" name="sign-in-username" value="${sessionScope.username}"/>
                </div>
                <div class="input-field">
                    <i class="fas fa-lock"></i>
                    <input type="password" placeholder="Password" name="sign-in-password" value="${sessionScope.password}"/>
                </div>
